# Интерфес для управлением промышленной роботизированной линии (Ручное управление)
## Устновка
...
- Motion - библиотека для управлением роботом
- Openpyxl - бибилиотека для работы с файлами расширения Excel  

Остальные библиотеки (sys, os, math, time и datetime) уже предустановлены в Python.  

Чтоб запустить программу, вам нужно скачать код программы с гита (либо скачать архив, либо скопировать репозиторий через git). После этого вы можте запустить код двумя способами:
- Через терминал: 
```bash 
python3 main.py
```
